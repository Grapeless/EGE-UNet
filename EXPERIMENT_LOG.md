...
### 模块A：坐标注意力 (Coordinate Attention, CA)
...
**状态**: [x] 待实现 → [x] 已实现 → [x] 已验证 → [ ] 已测试

---

### 模块B：边界感知监督 (Boundary-Aware Supervision, BAS)
...
- Sensitivity
- Specificity
- HD95 (Hausdorff Distance 95, 边界质量指标) ← **新增**
